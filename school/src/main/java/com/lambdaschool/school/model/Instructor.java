...
@ApiModel(value = "Instructor", description = "This model represents an instructor")
@Entity
@Table(name = "instructor")
public class Instructor
{

    @ApiModelProperty(name = "instructid", value = "id of instructor", required = true, example = "1")
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    private long instructid;


    @ApiModelProperty(name = "instructname", value = "name of instructor", required = true, example = "John")
